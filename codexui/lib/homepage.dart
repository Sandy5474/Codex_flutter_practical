...
class _homepageState extends State<homepage> {
  ...
  List screens = [Profile(), Profile(), Profile(), Profile(), Profile()];
        ...
        bottomNavigationBar: SalomonBottomBar(
          ...
          items: [
            SalomonBottomBarItem(
                icon: Icon(iconList[0]), title: Text(iconTitle[0])),
            SalomonBottomBarItem(
                icon: Icon(iconList[1]), title: Text(iconTitle[1])),
            SalomonBottomBarItem(
                icon: Icon(iconList[2]), title: Text(iconTitle[2])),
            SalomonBottomBarItem(
                icon: Icon(iconList[3]), title: Text(iconTitle[3])),
            SalomonBottomBarItem(
                icon: InkWell(
                  child: Container(
                    height: 23,
